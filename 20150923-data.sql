...
CREATE TABLE IF NOT EXISTS `php38_comment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `member_id` mediumint(8) unsigned NOT NULL COMMENT '会员id',
  `goods_id` mediumint(8) unsigned NOT NULL COMMENT '商品id',
  `addtime` int(10) unsigned NOT NULL COMMENT '评论时间',
  `content` varchar(200) NOT NULL COMMENT '评论内容',
  `star` tinyint(3) unsigned NOT NULL DEFAULT '5' COMMENT '评分分值',
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`),
  KEY `addtime` (`addtime`),
  KEY `member_id` (`member_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='评论' AUTO_INCREMENT=52 ;

--
-- 转存表中的数据 `php38_comment`
--

INSERT INTO `php38_comment` (`id`, `member_id`, `goods_id`, `addtime`, `content`, `star`) VALUES
(1, 3, 25, 0, '再测试一下！！！', 4),
(2, 3, 25, 1442973991, '黄雪辰砝码', 5),
(3, 3, 25, 1442973997, '黄雪辰砝码', 5),
(4, 3, 25, 1442974000, '黄雪辰砝码', 5),
(5, 3, 25, 1442974005, '黄雪辰砝码', 5),
(6, 3, 25, 1442974010, '黄雪辰砝码', 5),
(7, 3, 25, 1442974018, '黄雪辰砝码', 5),
(8, 3, 25, 1442974148, '鞋套载', 4),
(9, 3, 25, 1442974160, '震荡大哥大要', 3),
(10, 3, 25, 1442974165, '震荡大哥大要魂牵梦萦', 3),
(11, 3, 25, 1442974177, '魂牵梦萦', 5),
(12, 3, 25, 1442974181, '魂牵梦萦大规模魂牵梦萦', 5),
(13, 3, 25, 1442974188, '发大水', 5),
(14, 3, 25, 1442974191, '发大水 霏霏械', 5),
(15, 3, 25, 1442974198, '发大水 霏霏械要 大 在', 5),
(16, 3, 25, 1442974203, '发大水 霏霏械要 大 在魂牵梦萦土地', 5),
(17, 3, 25, 1442974228, '魂牵梦萦', 5),
(18, 3, 25, 1442974313, '魂牵梦萦', 5),
(19, 3, 25, 1442974316, '魂牵梦萦震荡', 5),
(20, 3, 25, 1442974326, '发大水', 5),
(21, 3, 25, 1442974330, '发大水 魂牵梦萦暮云春树', 5),
(22, 3, 25, 1442974335, '发大水 魂牵梦萦暮云春树 发大水', 5),
(23, 3, 25, 1442974346, '震荡', 5),
(24, 3, 25, 1442974355, '震荡城佛挡杀佛要要要', 5),
(25, 3, 25, 1442974366, '震荡城佛挡杀佛要要要 魂牵梦萦魂牵梦萦基本', 5),
(26, 3, 25, 1442974376, '震荡城佛挡杀佛要要要 魂牵梦萦魂牵梦萦基本', 5),
(27, 3, 25, 1442974390, '震荡城佛挡杀佛要要要 魂牵梦萦魂牵梦萦基本', 5),
(28, 3, 25, 1442974480, '魂牵梦萦魂牵梦萦工大苏打', 3),
(29, 3, 25, 1442974505, '大规模栽植械s', 4),
(30, 3, 25, 1442974567, '要要要要', 4),
(31, 3, 25, 1442974615, '32443243232', 2),
(32, 3, 25, 1442974623, '32443243232', 2),
(33, 3, 25, 1442974647, '城32', 2),
(34, 3, 25, 1442974670, '43243432432', 2),
(35, 3, 25, 1442974696, '3243432', 5),
(36, 3, 25, 1442974960, '魂牵梦萦霏霏械', 3),
(37, 3, 25, 1442974991, '43243432', 3),
(38, 3, 25, 1442975344, '213321321321', 5),
(39, 3, 25, 1442975389, '321321321321321', 3),
(40, 3, 25, 1442975422, '321321321321', 5),
(41, 3, 25, 1442975458, '213232123321', 2),
(42, 3, 25, 1442975474, '213232123321', 2),
(43, 3, 25, 1442975480, '213232123321', 2),
(44, 3, 25, 1442975531, '32132123321321', 3),
(45, 3, 25, 1442975831, '1236457895', 3),
(46, 3, 25, 1442977132, 'trretert', 3),
(47, 3, 25, 1442977141, 'gfgfgfgf', 5),
(48, 3, 25, 1442979142, '21321', 5),
(49, 3, 25, 1442979841, '再添加一个！！1', 3),
(50, 3, 25, 1442979856, '添加再！！@#！', 5),
(51, 3, 25, 1442979878, '霏霏奇才', 3);
...
CREATE TABLE IF NOT EXISTS `php38_goods` (
  ...
  `is_floor` enum('是','否') NOT NULL DEFAULT '否' COMMENT '是否推荐到楼层',
  `is_sphinx_updated` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否被修改了，需要重新建索引',
  PRIMARY KEY (`id`),
...
INSERT INTO `php38_goods` (`id`, `goods_name`, `market_price`, `shop_price`, `logo`, `sm_logo`, `mid_logo`, `goods_desc`, `is_on_sale`, `addtime`, `cat_id`, `admin_id`, `type_id`, `promote_price`, `promote_start_date`, `promote_end_date`, `is_hot`, `is_rec`, `is_new`, `sort_number`, `is_floor`, `is_sphinx_updated`) VALUES
(16, '新的联想商品321', '12.00', '333.00', 'Goods/2015-09-06/55eb9e60d5ffe.jpg', 'Goods/2015-09-06/sm_55eb9e60d5ffe.jpg', 'Goods/2015-09-06/mid_55eb9e60d5ffe.jpg', '', '是', 1441504302, 18, 0, 2, '300.00', 1441814400, 1442678399, '否', '否', '否', 100, '是', 0),
(18, '2321321', '222.00', '222.00', 'Goods/2015-09-08/55ee8ddeaa2a9.gif', 'Goods/2015-09-08/sm_55ee8ddeaa2a9.gif', 'Goods/2015-09-08/mid_55ee8ddeaa2a9.gif', '', '是', 1441526225, 2, 0, 3, '111.00', 1442073600, 1442678399, '否', '否', '否', 50, '是', 0),
(19, 'aaaaaaaaaaaaaaaa', '0.00', '0.00', 'Goods/2015-09-08/55ee97bf920c8.gif', 'Goods/2015-09-08/sm_55ee97bf920c8.gif', 'Goods/2015-09-08/mid_55ee97bf920c8.gif', '&lt;p&gt;&lt;script&gt;alert(123);&lt;/script&gt;&lt;/p&gt;', '是', 1441531783, 19, 0, 0, '0.00', 0, 57599, '否', '是', '否', 100, '是', 0),
(20, '213', '0.00', '0.00', 'Goods/2015-09-09/55efd19c8c482.jpg', 'Goods/2015-09-09/sm_55efd19c8c482.jpg', 'Goods/2015-09-09/mid_55efd19c8c482.jpg', '&lt;p&gt;&lt;img src=&quot;http://www.38s.com/Public/umeditor1_2_2-utf8-php/php/upload/20150908/14416998286796.gif&quot; _src=&quot;http://www.38s.com/Public/umeditor1_2_2-utf8-php/php/upload/20150908/14416998286796.gif&quot;/&gt;&lt;/p&gt;', '是', 1441678232, 14, 0, 0, '0.00', 0, 0, '否', '否', '否', 100, '否', 0),
(21, 'fdsafdsfds', '0.00', '0.00', 'Goods/2015-09-09/55eff5c4bc3d0.jpg', 'Goods/2015-09-09/thumb_1_55eff5c4bc3d0.jpg', 'Goods/2015-09-09/thumb_0_55eff5c4bc3d0.jpg', '', '是', 1441706572, 4, 0, 0, '0.00', 0, 0, '否', '否', '否', 100, '否', 0),
(22, 'images```', '0.00', '0.00', 'Goods/2015-09-09/55eff2bfc447d.jpg', 'Goods/2015-09-09/thumb_1_55eff2bfc447d.jpg', 'Goods/2015-09-09/thumb_0_55eff2bfc447d.jpg', '', '是', 1441788607, 18, 1, 0, '0.00', 0, 57599, '是', '否', '否', 100, '否', 0),
(25, '上海', '100.00', '100.00', 'Goods/2015-09-15/55f76ce7656ef.jpg', 'Goods/2015-09-15/thumb_1_55f76ce7656ef.jpg', 'Goods/2015-09-15/thumb_0_55f76ce7656ef.jpg', '<p><span style="font-size:48px;"><span style="background-color:rgb(255,0,0);">红<strong>色</strong>的</span></span></p><p><span style="background-color:rgb(255,0,0);"></span><img src="http://www.38s.com/Public/umeditor1_2_2-utf8-php/php/upload/20150915/14423060958193.jpg" alt="14423060958193.jpg" /></p>', '是', 1441940181, 18, 1, 2, '90.00', 1441814400, 1442419199, '是', '否', '否', 100, '否', 0),
(26, '商品属性测试', '123.00', '111.00', 'Goods/2015-09-12/55f3990367298.gif', 'Goods/2015-09-12/thumb_1_55f3990367298.gif', 'Goods/2015-09-12/thumb_0_55f3990367298.gif', '', '是', 1442020927, 18, 1, 2, '0.00', 0, 57599, '否', '是', '是', 100, '否', 0),
(27, 'abababab', '100.00', '100.00', 'Goods/2015-09-15/55f76ccc7ecc1.jpg', 'Goods/2015-09-15/thumb_1_55f76ccc7ecc1.jpg', 'Goods/2015-09-15/thumb_0_55f76ccc7ecc1.jpg', '', '是', 1442201085, 17, 1, 0, '80.00', 1442073600, 1442332799, '否', '是', '是', 75, '否', 0);
...
--
-- 转存表中的数据 `php38_login_error`
--

INSERT INTO `php38_login_error` (`ip`, `logtime`) VALUES
(2147483647, 1442998117),
(2147483647, 1442997792);
...
INSERT INTO `php38_member` (`id`, `email`, `name`, `password`, `regtime`, `regip`, `face`, `gender`, `status`, `jifen`, `jyz`, `qq_openid`) VALUES
(2, 'fortheday@126.com', '', 'bcdbcd', 1442286602, 2130706433, '', '保密', 1, 0, 200000, ''),
(3, '56370276@qq.com', '', '8496c2aba2445b76812e1099e60d08ee', 1442299315, 2130706433, 'Member/2015-09-23/thumb_0_560268a4838d8.jpg', '保密', 1, 0, 200000, '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='定单基本信息' AUTO_INCREMENT=5 ;
...
(3, 3, 1442711965, 1, 0, '1472.20', '吴英雷', '上海', '东城区', '西三旗', '西三旗', '12332131', '', '普通快递送货上门', '在线支付'),
(4, 3, 1442971728, 1, 0, '1557.20', '吴英雷', '上海', '东城区', '西三旗', '西三旗', '12332131', '', '普通快递送货上门', '在线支付');
...
(3, 2, 18, '', 100, '111.00'),
(3, 3, 25, '29,32', 4, '85.00'),
(3, 3, 18, '', 6, '188.70'),
(3, 4, 18, '', 6, '188.70'),
(3, 4, 25, '29,32', 5, '85.00');
...
CREATE TABLE IF NOT EXISTS `php38_privilege` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='权限' AUTO_INCREMENT=50 ;
...
(47, '评论模块', '', '', '', 0),
(48, '评论列表', 'Admin', 'Comment', 'lst', 47),
(49, '删除评论', 'Admin', 'Comment', 'delete', 48);
...
--
-- 表的结构 `php38_sphinx_data`
--

CREATE TABLE IF NOT EXISTS `php38_sphinx_data` (
  `id` int(10) unsigned NOT NULL COMMENT '上次已经创建好索引的最大ID'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='sphinx自动更新';

--
-- 转存表中的数据 `php38_sphinx_data`
--

INSERT INTO `php38_sphinx_data` (`id`) VALUES
(27);
...
CREATE TABLE IF NOT EXISTS `php38_yinxiang` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `goods_id` mediumint(8) unsigned NOT NULL COMMENT '商品id',
  `yx_name` varchar(30) NOT NULL COMMENT '印象名称',
  `yx_count` smallint(5) unsigned NOT NULL COMMENT '印象出现的次数',
  PRIMARY KEY (`id`),
  KEY `goods_id` (`goods_id`)
